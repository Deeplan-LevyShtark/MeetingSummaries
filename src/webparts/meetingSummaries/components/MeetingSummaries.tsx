              ...
              <div className={styles.ContainerForm}>
                ...
                {LoadingForm === 'Loading' ? <Loader /> : <section>
                  ...
                  <div className={styles.btnDiv}>
                    <Button variant="contained" color='success' sx={{ whiteSpace: 'nowrap', backgroundColor: '#8AC693', minWidth: '10em', textTransform: 'capitalize' }} onClick={() => this.submitForm('send')}>{t.SaveAndSend}</Button>
                    <Button variant="contained" color='primary' sx={{ whiteSpace: 'nowrap', minWidth: '10em', textTransform: 'capitalize' }} onClick={() => this.submitForm('save')}>{t.Save}</Button>
